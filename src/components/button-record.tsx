...
import {normalizePhone, ymReach} from "@/app/(frontend)/utils";
import {BUTTON_SIZE, BUTTON_TYPE, PHONE, TELEGRAM_LINK, WHATSAPP_LINK, YM_METHOD} from "@/app/(frontend)/consts";
